...
{
    public class DataContext : IdentityDbContext<AppUser>, IDataContextAsync
    {
        ...
        /// </summary>
        /// <exception cref="EntityBase.Infrastructure.DbUpdateException">
        ///     An error occurred sending updates to the database.</exception>
        /// <exception cref="EntityBase.Infrastructure.DbUpdateConcurrencyException">
        ...
        /// <exception cref="EntityBase.Validation.DbEntityValidationException">
